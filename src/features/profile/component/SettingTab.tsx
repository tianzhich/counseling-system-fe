...
type CounselorInfo = Pick<Counselor, 'audioPrice' | 'videoPrice' | 'ftfPrice' | 'motto'> & { city: string }
...
export default class SettingTab extends React.Component<ISettingTabProps, ISettingTabState> {
    ...
    handleChangeInfos = <T extends StateKey, K extends InfoKey<T>>(type: T, key: K, val: ISettingTabState[T] extends {[key: string]: any} ? ISettingTabState[T][K] : never) => {
        this.setState({
            ...this.state,
            [type]: {
                ...this.state[type],
    ...
    render() {
        ...
        const counselorInfo = this.props.counselorInfo
        ...
        return (
            <div className="tab-setting">
                ...
                <div className="item">
                    <div>电话</div>
                    <Input defaultValue={userInfo.phone} onChange={(e) => this.handleChangeInfos('userInfo', 'phone', e.target.value)} />
                </div>
                <div className="item">
                    <div>邮箱</div>
                    <Input defaultValue={userInfo.email} onChange={(e) => this.handleChangeInfos('userInfo', 'email', e.target.value)} />
                </div>
                <div className="action">
                    <Button type='primary' onClick={this.handleUpdateUserInfo} >更新个人资料</Button>
                </div>
                {
                    isCounselor ? (
                        <React.Fragment>
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <div className="item">
                                        <span>{showFtf ? '关闭' : '开通'}面对面咨询</span> <Switch checked={showFtf} onChange={this.handleToggleFtfSetting} />
                                    </div>
                                    {
                                            ...
                                            <React.Fragment>
                                                ...
                                                <div className="item">
                                                    ...
                                                    <Cascader
                                                        ...
                                                        placeholder={counselorInfo.ftfPrice === 0 ? '请选择' : counselorInfo.city.name}
                                                    />
                                                </div>
                                            </React.Fragment>
                                        ) : null
