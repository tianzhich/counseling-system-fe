...
export default class Basics extends React.Component<IBasicsProps, {}> {
    render() {
        ...
        const topicArr = this.props.couselor.topicOther ? this.props.couselor.topicOther.split(",") : [this.props.couselor.topic.name]
            ...
            <div className="tab-basics">
                <div className="info veri">
                    ...
                    <div>
                        ...
                        <div className="content">
                            {
                                descArr.map(d => <span key={d}>{d}<br /></span>)
                            }
                        </div>
                    </div>
                </div>
                <div className="info topic">
                    ...
                    <div>
                        ...
                        <div className="content">
                            {
                                topicArr.map(t => <span key={t}>{t}<br /></span>)
                            }
                        </div>
                    </div>
                </div>
